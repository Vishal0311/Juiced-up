package com.example.juiced_up.ui.fragments.Home.YouMayLike
...
import com.example.juiced_up.api.model.YouMayLike.Drink
...
class MayLikeAdapter: RecyclerView.Adapter<MayLikeAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                val bundle = Bundle()
                bundle.apply {
                    putString(ID,myList[adapterPosition].idDrink)
                    putString(NAME,myList[adapterPosition].strDrink) // call this to details fragment
                }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_you_may_like,parent,false))
    }
